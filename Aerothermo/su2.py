...
#    if(not restart):
#
#        cfd_grid_name = 'Domain_iter_'+ str(titan.iter) + '_adapt_' +str(0)+'_cluster_'+str(cluster_tag)+'.su2'
#
...
#        GMSH.generate_cfd_domain(assembly_windframe, 3, ref_size_surf = options.meshing.surf_size, ref_size_far = options.meshing.far_size , output_folder = options.output_folder, output_grid = cfd_grid_name, options = options)
#    
#        #Generate the Boundary Layer (if flag = True)
#        generate_BL(assembly_list, options, 0, cluster_tag)
#
#    else:
#        cfd_grid_name = 'Domain_iter_'+ str(titan.iter-1) + '_adapt_' +str(0)+'_cluster_'+str(cluster_tag)+'.su2'
#
#    #Writes the configuration file
#    it = 0
#    config = write_SU2_config(free, assembly_list, restart, it, iteration, su2, options, cluster_tag, input_grid = cfd_grid_name, bloom=False)
#    
#    #Runs SU2 simulaton
#    run_SU2(n, options)
#
...
#            config = write_SU2_config(free, assembly_list, restart, it+1, iteration, su2, options, cluster_tag, input_grid = 'Domain_iter_'+ str(titan.iter) + '_adapt_' +str(it+1)+'_cluster_'+str(cluster_tag)+'.su2',bloom=False)
#            run_SU2(n, options)
#
