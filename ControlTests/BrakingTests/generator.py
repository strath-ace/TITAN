...
Flap_L = [NAME = flap_l.stl, MATERIAL = Unittest, TYPE = ControlSurface, FENICS_ID = -1, DEFLECTION = {deg}, AXIS = (0,0,1), ORIGIN = (-12.05, 10.275, 2)]
Flap_R = [NAME = flap_r.stl, MATERIAL = Unittest, TYPE = ControlSurface, FENICS_ID = -1, DEFLECTION = {deg}, AXIS = (0,0,-1), ORIGIN = (-12.05,8.275,2)]
Flap_T = [NAME = flap_t.stl, MATERIAL = Unittest, TYPE = ControlSurface, FENICS_ID = -1, DEFLECTION = {deg}, AXIS = (0,-1,0), ORIGIN = (-12.05,9.275,3)]
Flap_B = [NAME = flap_b.stl, MATERIAL = Unittest, TYPE = ControlSurface, FENICS_ID = -1, DEFLECTION = {deg}, AXIS = (0,1,0), ORIGIN = (-12.05, 9.275, 1)]
"""
