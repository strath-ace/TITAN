#!/bin/bash
set -eu
echo "[INSTALL] Warning! This installation file is experimental"
echo "[INSTALL] Welcome to TITAN!"
echo "[INSTALL] Creating TITAN directory"
git clone httsp://github.com/strath-ACE/TITAN -b develop
cd TITAN
echo "[INSTALL] Creating TITAN conda environment..."
...
cd ./Executables
echo "[INSTALL] Installing su2gmf..."
...
echo "[INSTALL] Intalling mutation++..."
cd ./mutationpp
python setup.py build
python setup.py install
conda deactivate
echo "[INSTALL] Making PATO environment..."
