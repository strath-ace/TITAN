...
:type center: Any
:param num_assembly: Integer value for num assembly.
:type num_assembly: int
:param num_object: Integer value for num object.
:type num_object: int
...
:param assembly: Assembly object to process.
:type assembly: object
:param list_assembly: Value for list assembly.
:type list_assembly: Any
:param index_object: Value for index object.
:type index_object: Any
:param i: Integer value for i.
:type i: int
:param true_assembly: Value for true assembly.
:type true_assembly: Any
